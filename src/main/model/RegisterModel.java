...
public class RegisterModel {
    ...
    // Since this page is also used by admins on the AddUpdateAccountController, this is used to retrieve the details
    // of a selected user when editing an account.
    ...
    // This method performs two checks via two other methods by checking if the input username is acceptable, and if the
    // input employee id is also acceptable.
